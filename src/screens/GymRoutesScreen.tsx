...
type GymRoutesScreenNavigationProp = CompositeNavigationProp<
  NativeStackNavigationProp<HomeStackParamList, 'GymRoutes'>,
...
export const GymRoutesScreen = () => {
  ...
  const navigation = useNavigation<GymRoutesScreenNavigationProp>();
